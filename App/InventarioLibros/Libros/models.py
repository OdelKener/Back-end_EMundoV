...
class Libro(models.Model):
    ...
    existencia = models.BigIntegerField(verbose_name='Existencia', null=True, blank=True, default=0)
    ...
    def __str__(self):
        return f'{self.nombre} - Existencia: {self.existencia} - Costo: {self.costoactual}'
